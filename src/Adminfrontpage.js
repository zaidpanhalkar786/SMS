  ...
  return (
    <div>
      <div>
        ...
        <Divider style={{ margin: '3rem 0', display: 'inline-block' }} />
      </div>

      <div style={{ display: 'flex', justifyContent: 'left' }}>
        <a
          href="/admin-skillcatalog"
          style={{ marginRight: '240px', marginLeft: '5px' }}
        >
        ...
        <a href="/admin-generatereport" style={{ marginRight: '240px' }}>
